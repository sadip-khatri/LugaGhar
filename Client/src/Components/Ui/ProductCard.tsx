    ...
    <div className="group bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="flex gap-2 mt-auto">
          ...
          <Link
            to={`/product/${id}`}
            className="bg-[var(--color-bg)] text-[var(--color-text)] py-2 px-4 rounded-md font-medium hover:bg-[var(--color-secondary)] hover:text-[var(--color-bg)] transition-colors duration-200 flex items-center justify-center border border-[var(--color-secondary)]"
          >
            View
          </Link>
        </div>
